    ...
    <Card>
      ...
      <CardContent>
        ...
        <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
          <AvatarGroup sx={{ mr: 2 }}>
            <Avatar src='https://avatars.dicebear.com/api/bottts/3.png' alt='Olivia Sparks' />
            <Avatar src='https://avatars.dicebear.com/api/bottts/5.png' alt='Howard Lloyd' />
            <Avatar src='https://avatars.dicebear.com/api/bottts/4.png' alt='Hallie Richards' />
            <Avatar src='https://avatars.dicebear.com/api/bottts/2.png' alt='Alice Cobb' />
          </AvatarGroup>
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
