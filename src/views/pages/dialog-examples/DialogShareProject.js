        ...
        <DialogContent sx={{ px: { xs: 8, sm: 15 }, py: { xs: 8, sm: 12.5 }, position: 'relative' }}>
          ...
          <Autocomplete
            ...
            renderOption={(props, option) => (
              <ListItem {...props}>
                <ListItemAvatar>
                  <Avatar src={`https://avatars.dicebear.com/api/bottts/${option.avatar}`} alt={option.name} sx={{ height: 28, width: 28 }} />
                </ListItemAvatar>
          ...
          <List dense sx={{ py: 4 }}>
            {data.map(member => {
              return (
                ...
                >
                  <ListItemAvatar>
                    <Avatar src={`https://avatars.dicebear.com/api/bottts/${member.avatar}`} alt={member.name} />
                  </ListItemAvatar>
                  <ListItemText
                    primary={member.name}
