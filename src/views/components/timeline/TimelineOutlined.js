      ...
      <TimelineItem>
        ...
        <TimelineContent>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
            <Box sx={{ display: 'flex' }}>
              <Avatar src='https://avatars.dicebear.com/api/bottts/2.png' sx={{ width: '2rem', height: '2rem', mr: 2 }} />
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <Avatar src='https://avatars.dicebear.com/api/bottts/1.png' sx={{ width: '2rem', height: '2rem', mr: 2 }} />
            <Typography variant='subtitle2' sx={{ fontWeight: 600 }}>
              John Doe (Client)
            </Typography>
          </Box>
